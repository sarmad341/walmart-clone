...
export default function Home() {
  return (
    <main className="">
      ...
      <GridOption
        title="Shop Wardrobe"
        image="https://links.papareact.com/8k0"
      ...
      <GridOption
        title="Shop Toys"
        image="https://links.papareact.com/pi2"
      ...
      <GridOption
        title="Shop Gadgets"
        image="https://links.papareact.com/q5i"
      ...
      <GridOption
        ...
        image="https://links.papareact.com/g9f"
        className="bg-rose-100 h-64"
      />
      <GridOption
        title="Flash Deals"
        image="https://links.papareact.com/q7x"
